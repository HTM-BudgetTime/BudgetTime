...
REPLACE INTO `accounts` (`username`, `password`, `personal_name`, `family_name`)
VALUES ('test1', 'test1', 'Steve', 'Smith'),
       ('test2', 'test2', 'Jenny', 'Jones');
...
REPLACE INTO `budgets` (`budget_id`, `owner_username`, `description`)
VALUES (0, 'test1', ''),
       (1, 'test1', ''),
       (2, 'test2', '');
